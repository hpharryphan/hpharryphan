...
## Featured Projects
*(Note: I am currently uploading my project repositories!)*

* **[Project Name 1]:** Built a [what it is] using [tools used] to solve [the problem].
* **[Project Name 2]:** Designed and tested a [what it is] resulting in [the outcome].
